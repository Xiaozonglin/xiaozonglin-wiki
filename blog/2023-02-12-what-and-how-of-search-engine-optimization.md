...
目前，搜索引擎优化正在向着搜索引擎主动方向发展。也就是一些搜索引擎优化的手段正在变成徒劳，由搜索引擎自己开发的算法来鉴别出高质量内容。换句话说，网站只要关心如何生产高质量内容就可以了，生产出高质量内容的网站排名自然也会高。相关话题可以参考 [Meta Keywords：是什么、为什么不](https://blog.skk.moe/post/say-no-to-meta-keywords/)。
